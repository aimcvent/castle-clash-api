...
public class RoleSettingKey {
    ...
    public static final String UP_PROXIMITY_HEAL_DISTANCE_IDENTIFIER = "up.proximity.heal.distance";
    public static final int UP_PROXIMITY_HEAL_DISTANCE_VALUE = 10;
